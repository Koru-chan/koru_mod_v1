...
public class ForgeScreen extends HandledScreen<ForgeScreenHandler> {
    private static final Identifier GUI_TEXTURE =
            Identifier.of(TutorialMod.MOD_ID, "textures/gui/forge/forge_gui.png");
    private static final Identifier ARROW_TEXTURE =
            Identifier.of(TutorialMod.MOD_ID, "textures/gui/arrow_progress.png");
    private static final Identifier LIT_TEXTURE =
            Identifier.of(TutorialMod.MOD_ID, "textures/gui/lit_progress.png");
    ...
    private void renderProgressArrow(DrawContext context, int x, int y) {
        if(handler.isCrafting()) {
            context.drawTexture(ARROW_TEXTURE, x + 79, y + 50, 0, 0,
