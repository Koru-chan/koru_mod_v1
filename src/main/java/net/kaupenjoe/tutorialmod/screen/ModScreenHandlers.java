...
public class ModScreenHandlers {
    ...
    public static final ScreenHandlerType<ForgeScreenHandler> GROWTH_CHAMBER_SCREEN_HANDLER =
    ...
    public static final ScreenHandlerType<ForgeScreenHandler> FORGE_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(TutorialMod.MOD_ID, "forge_screen_handler"),
                    new ExtendedScreenHandlerType<>(ForgeScreenHandler::new, BlockPos.PACKET_CODEC));
